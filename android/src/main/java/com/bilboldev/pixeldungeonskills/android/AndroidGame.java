...
import com.bilboldev.pixeldungeonskills.Preferences;
...
public class AndroidGame extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		if (instance == null) {
			...
			Preferences.INSTANCE.set(instance.getPreferences("PixelDungeon"));
		} else {
			instance = this;
		}
		...
		if (PixelDungeon.landscape() != null) {
			instance.setRequestedOrientation( PixelDungeon.landscape() ?
		...
		config.useImmersiveMode = PixelDungeon.immersed();
		...
		initialize(new PixelDungeon(support), config);
