...
package com.bilboldev.pixeldungeonskills.android;
...
public class AndroidPlatformSupport extends PlatformSupport {
	...
	public void updateDisplaySize(){
		if (PixelDungeon.landscape() != null) {
			android.util.Log.d("App", "RequestedOrientation " + PixelDungeon.landscape());
			AndroidGame.instance.setRequestedOrientation( PixelDungeon.landscape() ?
		...
		if (fullscreen && PixelDungeon.landscape() != null
				&& (Game.dispWidth >= Game.dispHeight) != PixelDungeon.landscape()){
		...
		if (powerSaver && fullscreen){
			...
			if (finalW != Game.width || finalH != Game.height){
				...
				AndroidGame.instance.runOnUiThread(new Runnable() {
					@Override
					public void run() {
						android.util.Log.d("App", "setFixedSize " + PixelDungeon.landscape());
			...
			AndroidGame.instance.runOnUiThread(new Runnable() {
				@Override
				public void run() {
					android.util.Log.d("App", "setSizeFromLayout " + PixelDungeon.landscape());
	...
	public void updateImmersiveMode() {
		try {
			((AndroidGame) AndroidGame.instance).useImmersiveMode(PixelDungeon.immersed());
		}catch(Exception e) {
