...
public abstract class Mob extends Char {
	...
	public boolean continueAttack = true;
	...
	protected boolean doAttack( Char enemy ) {
		...
		DeviceCompat.log("Actor", "Mob doAttack. frame:" + Actor.getFrame() + " " + this);
		return true;
	}
	...
	private class Hunting implements AiState {
		...
		@Override
		public boolean act( boolean enemyInFOV, boolean justAlerted ) {
			DeviceCompat.log("Actor", "Mob act.      frame:" + Actor.getFrame() + " " + Mob.this);
			...
			if (enemyInFOV && canAttack( enemy )) {
				...
				// fix merc go to pit
				// && enemy != null
				if (target != -1 && enemy != null && getCloser( target )) {
