...
public class HiredMerc extends NPC {
    ...
    public static boolean archerMaidenUnlocked = true;
    ...
    protected boolean canAttack( Char enemy ) {
        ...
        // fix merc hit summonedpet/ merc
        /*if (enemy instanceof SummonedPet || enemy instanceof HiredMerc) {
            return false;
        }*/
    ...
    public void die(Object src)
    {
        ...
        DeviceCompat.log("Actor", "Merc die. carrying:" + (carrying!=null?carrying.name() : "null"));
    ...
    protected Char chooseEnemy() {
        ...
        if (enemy == null || !enemy.isAlive()) {
            ...
            for (Mob mob:Dungeon.level.mobs) {
                // fix merc hit merc
                if (mob.hostile && Level.fieldOfView[mob.pos]/* && (!(mob instanceof SummonedPet) && !(mob instanceof HiredMerc))*/) {
                    enemies.add( mob );
                }
            }
    ...
    private class Wandering implements AiState {
        ...
        public boolean act( boolean enemyInFOV, boolean justAlerted ) {
            // DeviceCompat.log("Path", "act wandering pos:" + pos + " hero pos:" + Dungeon.hero.pos);
            ...
            if (enemyInFOV) {
                ...
                int oldPos = pos;
                // DeviceCompat.log("Path", "\tget closer pos:" + pos + " hero pos:" + Dungeon.hero.pos);
