...
import com.bilboldev.pixeldungeonskills.ui.SmallRedButton;
...
public class WndRatKing extends WndTabbed {
    ...
    private SmallRedButton btnScoutRodent;
    private SmallRedButton btnFodderRodent;
    private SmallRedButton btnRangerRodent;

    private SmallRedButton btnBuyFood;
	...
	public WndRatKing(Mode mode) {
        ...
        if(mode == Mode.NORMAL) {
            ...
            btnScoutRodent = new SmallRedButton("SCOUT RODENT - 50 Gold") {
                @Override
                protected void onClick() {
                    if (Dungeon.gold < 50) {
                        text(TXT_NO_GOLD);
            ...
            btnFodderRodent = new SmallRedButton("FODDER RODENT - 10 Gold") {
                @Override
                protected void onClick() {
          ...
          //  add(btnFodderRodent.setRect(w/2, btnScoutRodent.bottom() + GAP, WIDTH - 1 * w, BTN_HEIGHT  + GAP));
            ...
            btnRangerRodent = new SmallRedButton("RANGER RODENT - 25 Gold") {
                @Override
                protected void onClick() {
          ...
          //  add(btnRangerRodent.setRect(w/2, btnFodderRodent.bottom()  + GAP, WIDTH - 1 * w, BTN_HEIGHT  + GAP));
            ...
            btnBuyFood = new SmallRedButton("Food Scraps - " + (int)cost + " Gold") {
                @Override
                protected void onClick() {
