    ...
    public WndMercs(final Mode mode)
    {
        ...
        else
        {
            ...
            if(mode == Mode.BRUTE) {
                ...
                PointerArea hotArea_imageWeapon = new PointerArea(imageWeapon) {
                    @Override
                ...
                PointerArea hotArea_imageArmo = new PointerArea(imageArmor) {
                    @Override
                    protected void onClick(PointerEvent touch) {
                        Image tmp = new Image();
                        tmp.copy(imageArmor);
                ...
                PointerArea hotArea_image = new PointerArea(image) {
                    @Override
                    protected void onClick(PointerEvent touch) {
                        Image tmp = new Image();
                        tmp.copy(image);
                ...
                PointerArea hotArea_imageSkill = new PointerArea(imageSkill) {
                    @Override
                    protected void onClick(PointerEvent touch) {
                        Image tmp = new Image();
                        tmp.copy(imageSkill);
            ...
            else if(mode == Mode.ARCHERMAIDEN)
            {
                ...
                PointerArea hotArea_imageSkillB = new PointerArea(imageSkillB) {
                    @Override
                    protected void onClick(PointerEvent touch) {
                        Image tmp = new Image();
