		...
		RedButton btnHire = new RedButton("Call Merc") {
			...
			protected void onClick() {
				...
				if(Dungeon.hero.hiredMerc == null)
					...
					Dungeon.hero.hiredMerc.sprite.scale.set(1.0f, 1.0f);
					Dungeon.hero.hiredMerc.sprite.am = 1.0f;
					...
					if(respawnPoints.size() > 0) {
						try {
							...
							PixelDungeon.reportException(new Throwable("something wrong, merc lost..."));
						}
					}
					hide();
				}
