...
public class GauntletStatusPane extends Component {
	...
	protected void createChildren() {
		...
		shield = new NinePatch( Assets.STATUS_GAUNTLET, 80, 0, 30   + 18, 0 );
		add( shield );
		...
		depth = new BitmapText( Integer.toString(GauntletScene.level), PixelScene.font1x );
	...
	protected void layout() {
		...
		depth.x = width - 8 - depth.width()    - 18;
		depth.y = 6;
	...
	private static class MenuButton extends Button {
		...
		protected void createChildren() {
			...
			image = new Image( Assets.STATUS_GAUNTLET, 114, 3, 12, 11 );
			add( image );
		}
