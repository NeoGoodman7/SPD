...
import com.bilboldev.pixeldungeonskills.actors.blobs.Alchemy;
...
import com.bilboldev.pixeldungeonskills.levels.traps.*;
                    ...
                    for (int nu = 0; nu < 1 ; nu++) {
                        ...
                        if (Actor.findChar(newPos) != null) {
                            ...
                            if (newPos != -1) {
								...
								DeviceCompat.log("Actor", "respawn merc carrying:" + tmp.carrying);
