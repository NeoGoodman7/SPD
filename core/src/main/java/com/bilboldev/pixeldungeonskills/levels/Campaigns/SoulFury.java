...
public class SoulFury extends Level {
    ...
    public class Temari extends HostileSkeleton
    {
        ...
        public void die(Object cause)
        {
            if(SoulFury.this.maestro.phase == 3 && SoulFury.this.maestro.counter >= 330) {
    ...
    public class Maestro extends ColdGirl
    {
        ...
        private static final float SPEND_TIME = 0.5f;

        @Override
        public boolean act()
        {
            // DeviceCompat.log("Actor", "Maestro act phase:" + phase + " counter:" + counter);
            if(hireThief){
                hireThief = false;
        ...
        //   }
            ...
            if(MissionScene.scenePause == true) {
                ...
                // Camera.main.focusOn(centerOfAttention.sprite);
            }
            next();
            return true;
        }
...
//
           ...
           // MissionScene.scenePause = true;
            ...
            DeviceCompat.log("Actor", "Maestro nextPhase->phase:" + phase + ",counter:" + counter);
        }
