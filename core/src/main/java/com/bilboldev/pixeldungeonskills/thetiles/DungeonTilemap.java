...
public abstract class DungeonTilemap extends DungeonTilemapOld {
	...
	public static PointF raisedTileToWorld( int pos ) {
		return new PointF( pos % Dungeon.level.width(), pos / Dungeon.level.width() - 0.2f  ).scale( SIZE );
	}
