...
public class GameScene extends PixelScene {
    ...
    protected Actor.IProcessValidator processValidator;

    protected Actor.IProcessValidator getProcessValidator() {
    	if (processValidator == null) {
    		processValidator = new Actor.IProcessValidator() {

				@Override
				public boolean check() {
					return Actor.getCurrent() != null;
				}
			};
		}
	...
	public void create() {
		...
		if (Dungeon.hero.hiredMerc != null && Dungeon.hero.hiredMerc.sprite != null) {
    ...
    public static FixedText fixedStatus() {
        return scene != null && scene.statuses != null ? (FixedText)scene.statuses.recycle( FixedText.class ) : null;
    }
