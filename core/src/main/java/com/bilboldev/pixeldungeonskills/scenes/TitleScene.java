...
public class TitleScene extends PixelScene {
	...
	public void create() {
        ...
        BitmapText version = new BitmapText( "v " + Game.version + " (Build " + Game.versionCode + ")", font1x );
        version.measure();
        version.hardlight( 0xFFFFFF );
        version.x = w - version.width() - 3;
     ...
     //   btnMovie.setPos( btnGame.right() + 4, 1 );
      //  add( btnMovie );
		...
		if( PixelDungeon.lastVersion() < Game.versionCode ) {
			PixelDungeon.lastVersion( Game.versionCode );
			add(VersionNewsInfo.getWelcomeWindow());
		}
