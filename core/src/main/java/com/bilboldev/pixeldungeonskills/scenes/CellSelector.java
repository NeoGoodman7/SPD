...
public class CellSelector extends ScrollArea {
	...
	@Override
	protected void onPointerDown( PointerEvent t ) {

		if (t != curEvent && another == null) {
	...
	@Override
	protected void onPointerUp( PointerEvent t ) {
		if (pinching && (t == curEvent || t == another)) {
	...
	@Override
	protected void onDrag( PointerEvent t ) {
